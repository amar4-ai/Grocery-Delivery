...
const ProductPage = () => {
  ...
  const {items, addToCart, updateQuantity, removeFromCart} = userCart()
    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span>/</span>
          <Link to={`/products?category=${product.category}`} className="hover:text-app-green
          ...
          <div className="p-6 md:p-10 flex flex-col justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={()=> {
                ...
                display:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}>
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              hover:text-app-orange-dark flex items-center gap-1 transition-colors" to={`/products?category=${product.category}`} >
              View All 
