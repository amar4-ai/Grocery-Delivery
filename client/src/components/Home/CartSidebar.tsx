  ...
  return (
    ...
    shadow-2xl flex flex-col animate-slide-in-right">
      ...
      border-app-border">
        ...
        rounded-full">{items.length}</span>
          </div>
        ...
        {items.length > 0 && (
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && <p className="text-xs text-app-text-light text-center">Free delivery on borders over {currency}20!</p>}
            ...
            <button onClick={() => { setIsCartOpen(false); navigate('/checkout'); window.scrollTo(0, 0) }} className="w-full py-3 bg-app-orange text-white font-semibold rounded-xl hover:bg-app-orange-dark transition-colors
          flex-center gap-22 active:scale-[0.98]">
